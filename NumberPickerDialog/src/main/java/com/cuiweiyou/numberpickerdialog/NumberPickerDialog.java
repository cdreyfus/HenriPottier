 ...
 *
 * Edited by cdreyfus on 2018/04/10
 */
public class NumberPickerDialog extends AlertDialog implements OnClickListener, NumberPicker.OnValueChangeListener {
     ...
     */
    public NumberPickerDialog(Context context, String title, NumberPicker.OnValueChangeListener callBack, int maxValueNumber, int minValueNumber, int currentValueNumber) {
        super(context, 0);
